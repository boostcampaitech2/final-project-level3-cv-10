...
//          inputImage.putFloat(((value and 0xFF) - mean) / std)
          inputImage.putFloat(pixel * 4, (value shr 16 and 0xFF) / std)
          inputImage.putFloat((pixel + gPos) * 4 , (value shr 8 and 0xFF) / std)
          inputImage.putFloat((pixel + bPos) * 4, (value and 0xFF) / std)
          pixel++
        }
      }
